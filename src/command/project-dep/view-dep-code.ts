...
export class ViewDepCode implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const indexPath = vscode.Uri.joinPath(this._extensionUri, 'src/command/project-dep', 'vite-project', 'dist', 'index.html');
    ...
    contentHtml = contentHtml.replace(/src="\/assets\//g, `src="${webview.asWebviewUri(vscode.Uri.file(
      vscode.Uri.joinPath(this._extensionUri, 'src/command/project-dep', 'vite-project', 'dist', 'assets').path
    ))}/`);
